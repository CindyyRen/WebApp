...
namespace WebApp.Migrations
{
    ...
    [Migration("20251201090827_HabitTags")]
    partial class HabitTags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Entities.Habit", b =>
                {
            ...
            modelBuilder.Entity("WebApp.Entities.HabitTag", b =>
                {
            ...
            modelBuilder.Entity("WebApp.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("WebApp.Entities.Habit", b =>
                {
                    b.OwnsOne("WebApp.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("WebApp.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("WebApp.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("WebApp.Entities.HabitTag", b =>
                {
                    b.HasOne("WebApp.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_habit_tag_habits_habit_id");

                    b.HasOne("WebApp.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_habit_tag_tags_tag_id");
                });
